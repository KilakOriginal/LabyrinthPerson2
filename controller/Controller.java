...
public class Controller extends JFrame implements KeyListener, ActionListener, MouseListener {
	...
	public void keyPressed(KeyEvent e) {
		...
		case KeyEvent.VK_R:
			System.out.println("Restarting...");	// R to restart
			this.world.restart();
			// No idea how to refresh the GraphicView
			break;

		case KeyEvent.VK_E:
			this.world.changeDifficulty(1);	// E to increase difficulty
			break;

		case KeyEvent.VK_Q:
			this.world.changeDifficulty(-1);	// Q to decrease difficulty
			break;
		}
	}
